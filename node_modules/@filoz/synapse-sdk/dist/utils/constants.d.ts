...
export declare const CHAIN_IDS: Record<FilecoinNetworkType, number>;
...
export declare const GENESIS_TIMESTAMPS: Record<FilecoinNetworkType, number>;
...
export declare const RPC_URLS: Record<FilecoinNetworkType, {
    http: string;
    websocket: string;
}>;

...
export class PDPServer {
    ...
    async createDataSet(clientDataSetId, payee, withCDN, recordKeeper) {
    ...
    async addPieces(dataSetId, clientDataSetId, nextPieceId, pieceDataArray) {
        ...
        const authData = await this.getAuthHelper().signAddPieces(clientDataSetId, nextPieceId, pieceDataArray, metadata);

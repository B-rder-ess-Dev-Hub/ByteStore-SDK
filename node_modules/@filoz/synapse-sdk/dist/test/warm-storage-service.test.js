        ...
        it('should return empty array when client has no data sets', async () => {
            ...
            cleanup = mockProviderWithView((data) => {
                if (data?.startsWith('0x967c6f21') === true) {
                    return ethers.AbiCoder.defaultAbiCoder().encode(['tuple(uint256,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,uint256)[]'], [[]]);
                }
                return null;
            });
        ...
        it('should return data sets for a client', async () => {
            ...
            cleanup = mockProviderWithView((data) => {
                if (data?.startsWith('0x967c6f21') === true) {
                    ...
                    return ethers.AbiCoder.defaultAbiCoder().encode(['tuple(uint256,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,uint256)[]'], [dataSets]);
                }
                return null;
            });
            const dataSets = await warmStorageService.getClientDataSets(clientAddress);
        ...
        it('should enhance data sets with PDPVerifier details', async () => {
            ...
            cleanup = mockProviderWithView((data) => {
                if (data?.startsWith('0x967c6f21') === true) {
                    ...
                    return ethers.AbiCoder.defaultAbiCoder().encode(['tuple(uint256,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,uint256)[]'], [[dataSet]]);
                }
        ...
        it('should return correct add pieces information', async () => {
            ...
            cleanup = mockProviderWithView((data) => {
                ...
                if (data?.startsWith('0xbdaac056') === true) {
                    ...
                    return ethers.AbiCoder.defaultAbiCoder().encode(['tuple(uint256,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,uint256)'], [info]);
                }
                return null;
            });
            mockProvider.getNetwork = async () => ({ chainId: 314159n, name: 'calibration' });

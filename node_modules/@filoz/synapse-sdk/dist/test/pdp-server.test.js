...
describe('PDPServer', () => {
    ...
    describe('createDataSet', () => {
        it('should handle successful data set creation', async () => {
            ...
            server.use(http.post('http://pdp.local/pdp/data-sets', () => {
                return new HttpResponse(null, {
                    status: 201,
                    headers: { Location: `/pdp/data-sets/created/${mockTxHash}` },
                });
            }));
            const result = await pdpServer.createDataSet(0, '0x70997970C51812dc3A010C7d01b50e0d17dc79C8', false, TEST_CONTRACT_ADDRESS);
    ...
    describe('getPieceAdditionStatus', () => {
        it('should handle successful status check', async () => {
            ...
            server.use(http.get('http://pdp.local/pdp/data-sets/:id/pieces/added/:txHash', ({ params }) => {
        ...
        it('should handle not found status', async () => {
            const mockTxHash = '0x7890abcdef1234567890abcdef1234567890abcdef1234567890abcdef123456';
            server.use(http.get('http://pdp.local/pdp/data-sets/:id/pieces/added/:txHash', () => {
                return new HttpResponse(null, {
                    status: 404,
                });
            }));
            try {
                ...
                assert.include(error.message, `Piece addition not found for transaction: ${mockTxHash}`);
            }
        });
        it('should handle server errors', async () => {
            ...
            try {
                ...
                assert.include(error.message, 'Failed to get piece addition status');
    ...
    describe('addPieces', () => {
        it('should validate input parameters', async () => {
            try {
                ...
                assert.include(error.message, 'At least one piece must be provided');
            }
        ...
        it('should handle successful piece addition', async () => {
            ...
            server.use(http.post('http://pdp.local/pdp/data-sets/:id/pieces', async ({ request }) => {
                try {
                    ...
                    assert.strictEqual(body.pieces[0].subPieces[0].subPieceCid, validPieceCid[0]);
                    return HttpResponse.text('Pieces added successfully', {
                        status: 201,
                    });
                }
                catch (error) {
                    return HttpResponse.text(error.message, {
                        status: 400,
                    });
                }
            }));
        ...
        it('should handle server errors appropriately', async () => {
            const validPieceCid = ['bafkzcibcd4bdomn3tgwgrh3g532zopskstnbrd2n3sxfqbze7rxt7vqn7veigmy'];
            server.use(http.post('http://pdp.local/pdp/data-sets/:id/pieces', () => {
            ...
            try {
                ...
                assert.include(error.message, 'Failed to add pieces to data set: 400 Bad Request - Invalid piece CID');
            }
        });
        ...
        it('should handle addPieces response with Location header', async () => {
            ...
            server.use(http.post('http://pdp.local/pdp/data-sets/:id/pieces', async () => {
                return HttpResponse.text('Pieces added successfully', {
                    status: 201,
                    headers: {
    ...
    describe('getDataSetCreationStatus', () => {
        it('should handle successful status check', async () => {
            ...
            server.use(http.get('http://pdp.local/pdp/data-sets/created/:tx', async () => {
                return HttpResponse.json(mockResponse, {
                    status: 200,
                });
            }));
        ...
        it('should handle not found status', async () => {
            ...
            try {
                ...
                assert.include(error.message, `Data set creation not found for transaction hash: ${mockTxHash}`);
            }
        });
    });
    describe('findPiece', () => {
        it('should find a piece successfully', async () => {
            ...
            server.use(http.get('http://pdp.local/pdp/piece', async () => {
                return HttpResponse.json(mockResponse, {
                    status: 200,
                });
            }));
    ...
    describe('uploadPiece', () => {
        it('should successfully upload data', async () => {
            ...
            server.use(http.post('http://pdp.local/pdp/piece', async ({ request }) => {
                try {
                    const body = await request.json();
        ...
        it('should handle existing piece (200 response)', async () => {
            const testData = new Uint8Array([1, 2, 3, 4, 5]);
            const mockPieceCid = 'bafkzcibcd4bdomn3tgwgrh3g532zopskstnbrd2n3sxfqbze7rxt7vqn7veigmy';
            server.use(http.post('http://pdp.local/pdp/piece', async () => {
    ...
    describe('downloadPiece', () => {
        it('should successfully download and verify piece', async () => {
            ...
            server.use(http.get('http://pdp.local/piece/:pieceCid', async () => {
    ...
    describe('ping', () => {
        it('should successfully ping a healthy provider', async () => {
            server.use(http.get('http://pdp.local/pdp/ping', async () => {
                return new HttpResponse(null, {
                    status: 200,
                });
            }));
        ...
        it('should use correct URL endpoint', async () => {
            let capturedUrl = '';
            server.use(http.get('http://pdp.local/pdp/ping', async ({ request }) => {
    ...
    describe('getDataSet', () => {
        it('should successfully fetch data set data', async () => {
            ...
            server.use(http.get('http://pdp.local/pdp/data-sets/292', async () => {
        ...
        it('should handle data set not found', async () => {
            server.use(http.get('http://pdp.local/pdp/data-sets/999', async () => {
        ...
        it('should handle server errors', async () => {
            ...
            try {
                ...
                assert.include(error.message, 'Failed to fetch data set');
                assert.include(error.message, '500');
                assert.include(error.message, 'Database error');
            }
        });
        it('should validate response data', async () => {
            ...
            try {
                ...
                assert.include(error.message, 'Invalid data set data response format');
            }
        });

    ...
    const provider = {
        ...
        call: async (transaction) => {
            ...
            if (data.includes('e3d4c69e') === true) {
                ...
                return ethers.AbiCoder.defaultAbiCoder().encode(['bool', 'uint256', 'uint256', 'uint256', 'uint256', 'uint256'], [isApproved, rateAllowance, rateUsed, lockupAllowance, lockupUsed, maxLockupPeriod]);
            }
            return '0x';
        },
